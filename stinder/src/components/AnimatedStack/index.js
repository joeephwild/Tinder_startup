        ...
        {currentProfile && (
          <PanGestureHandler onGestureEvent={gestureHandler}>
            <Animated.View style={[styles.animatedCard, cardStyle]}>
              <Animated.Image
                source={Like}
                style={[styles.like, {left: 5}, likeStyle]}
                resizeMode="contain"
              />
              <Animated.Image
                source={Nope}
                style={[styles.like, {right: 5}, nopeStyle]}
                resizeMode="contain"
              />
...
const styles = StyleSheet.create({
  ...
  like: {
    ...
    shadowOpacity: 0.25, // Adjust opacity as needed
    shadowRadius: 3.84, // Adjust radius as needed
  },
});
